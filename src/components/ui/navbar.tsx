        ...
        <header className="fixed w-full inset-x-0 z-50">
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-8 lg:px-8" aria-label="Global">
                <div className="flex lg:flex-1">
                    <Link href="/" className="w-auto text-xl font-semibold leading-6 nav-bar-text">
                        Kieran Sutherland
                    </Link>
                </div>
                ...
                <div className="hidden lg:flex lg:gap-x-12">
                    <Link href="projects" className="text-md font-semibold leading-6 nav-bar-text">Projects</Link>
                    <Link href="links" className="text-md font-semibold leading-6 nav-bar-text">Links</Link>
                </div>
            </nav>
